...
export default function SignUp() {
  ...
  return (
    <div className="min-w-screen min-h-screen  flex items-center justify-center px-5 py-5">
      <div className="bg-gray-100 text-gray-500 rounded-3xl  w-full overflow-hidden">
        <div className="md:flex w-full">
          ...
          <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
            <div className="text-center mb-10">
              <h1 className="font-bold text-3xl text-cyan-500">REGISTER</h1>
              <p className="mt-2">Enter your information to register</p>
            </div>
            <div>
              <form className="w-1/2 mx-auto" onSubmit={handleRegister}>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button
                      type="submit"
                      className="block w-full max-w-xs mx-auto bg-cyan-500 hover:bg-cyan-700 focus:bg-cyan-700 text-white rounded-lg px-3 py-3 font-semibold"
                    >
                      REGISTER NOW
                    </button>
                  </div>
